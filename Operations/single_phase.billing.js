    ...
    try {
        ...
        dbConf.pool.open(dbConf.connStr, (err, conn) => {
            ...
            if (_formatData != undefined) {
                ...
                ProcessSPBill(blmicmtrmdl, cmrcctoutrfmst, from, to);
            }
        });
    }
    catch (err) {
...
async function ProcessSPBill(blmicmtrmdl, cmrcctoutrfmst, from, to) {
    try {
        ...
        dbConf.pool.open(dbConf.connStr, (err, conn) => {
            ...
            let trfData = dbConf.runSQL(conn, _query);
            conn.close();
...
async function ProcessExcelFile(blmicmtrmdl, cmrcctoutrfmst,SP_Bill,SP_Bill_Gen, xlFilePath,_trfData) {
    try {
